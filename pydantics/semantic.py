...
class RouteSearchRequest(BaseModel):
    ...
    semantic_query: str = Field(..., description="Câu query ngữ nghĩa (nhu cầu người dùng): 6 option đã cố định nhập đúng 6 option, chia cách mỗi trường bằng dấu ,", json_schema_extra={"example": "Food & Local Flavours"})
    customer_like: Optional[bool] = Field(None, description="Tự động thêm Culture & heritage nếu True, Chiều lòng khách hàng", json_schema_extra={"example": True})
