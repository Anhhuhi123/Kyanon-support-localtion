...
class POIUpdateService:
    ...
    #     """
    #     Chọn POI tốt nhất từ danh sách candidates dựa trên distance + rating
    ...
    #             # Combined score: 60% rating + 40% distance (không có similarity và bearing)
